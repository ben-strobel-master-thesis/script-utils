...
one_simulator_utils.convert_one_simulator_output_to_emercast_scenario("./scenarios/one-simulator-output/random-city-1_LocationSnapshotReport.txt", "./scenarios/emercast-simulator-input/random-city-1.emerscenario", min_bound)
